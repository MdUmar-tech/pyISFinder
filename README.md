...
Run the standalone database downloader helper:

```bash
python3 download_db.py
```
*(This automatically downloads the curated transposase profile HMM database into `./db/`)*
...
├── download_db.py         # Dedicated database downloader script
